...
createNft() {
    ...
    local ROYALTIES=0x$(printf '%x\n' 5)
    local URI=0x68747470733a2f2f697066732e696f2f697066732f516d6177554650414d474737463546766f384773736f6d344868655a587975435a346e6455724a414173416438483f66696c656e616d653d6c696f6e2e6a7067 #elrond converter + 0x
    local SELLING_PRICE=0x$(printf '%x\n' 1)
